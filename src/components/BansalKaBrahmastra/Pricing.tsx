    ...
    <section id="pricing" className="bg-secondary/5 py-6 sm:py-10">
      <div className="container px-4 sm:px-6">
        ...
        <div className="mx-auto max-w-6xl py-8 pb-0 hidden sm:block">
          <div className="grid grid-cols-2 gap-0 rounded-xl border shadow-lg">
            {/* Features column */}
            ...
            {plans.map((plan) => (
              ...
              >
                {plan.badge && (
                  <div
                    className={`absolute top-0 left-0 right-0 text-white text-center py-1 text-xs font-medium`}
                  >
                    {plan.badge}
                  </div>  
                )}
