...
import Button from "@/components/ui/Button/SecButton";
import { Badge } from "@/components/ui/badge";

export default function Hero() {
  const handleBuyNowClick = () => {
    window.open("https://com.rpy.club/pdp/bansalkaabrahmastra", "_blank", "noopener,noreferrer");
  };

  return (
    <section className="relative w-full overflow-hidden min-h-[calc(100vh-4rem)] lg:py-10">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1">
            ...
            <div className="md:hidden flex items-center justify-center lg:justify-start gap-3 mt-4">
              <Button 
                ...
                className="text-sm lg:text-base px-6 bg-secondary/80"
              />
            </div>
          </div>
          ...
          <div className="lg:col-span-5 order-1 lg:order-2">
            ...
            <div className="hidden lg:block relative">
              ...
              <div className="relative z-10 mb-12 transform-gpu rotate-6 hover:rotate-0 transition-all duration-700">
                ...
                {/* Floating badges */}
                <div className="absolute -right-6 top-0 bg-white shadow-xl px-4 py-2 rounded-lg transform rotate-12">
                ...
                <div className="absolute left-[30%] -bottom-20 px-6 py-3 shadow-lg transform -rotate-3">
                  <Button
                    title=" Buy Now"
                    onClick={handleBuyNowClick}
                    className="text-sm lg:text-base px-6 bg-secondary"
                  />
                </div>
              </div>
            </div>
