...
export default function ChakravyuhCourseHindiPage() {
                  ...
                  >
                    <SwiperSlide className="flex items-center justify-center">
                      <div className="w-full h-full relative">
                        ...
                        <Image
                          src="https://learnrkb.in/iamrakeshbansal/courses/RenkoHindi.png"
                          alt="Course Preview"
                          fill
                    ...
                    <SwiperSlide className="flex items-center justify-center">
                      <div className="w-full h-full">
                        <iframe
                          src={`https://learnrkb.in/iamrakeshbansal/courses/ChakraHindi.mp4`}
